...
const ITEM_PLACEHOLDERS = {
  ...
  "Role Clarity|Decision-making authority & process": "e.g. We generally use the consent model to make decisions. Everyone in the organization has veto power, if they believe a decision is not safe to try. We also have a one-page decision-making framework that sets out what each level of the organisation can decide independently, what requires consultation, and what requires sign-off from the ED or board. For example, heads of departments can make budget changes up to $10,000. Changes from $10,000 to $50,000 need to be approved by the ED and over $50,000 need to be approved by the board. Another example: policy leads can commit to coalition positions without sign-off if they fall within agreed campaign parameters; anything outside those parameters requires ED approval. The framework was developed only a few months ago and not everyone understands or uses it yet. See decision-making framework linked below.",
  ...
  "Role Clarity|Board clarity": "e.g. We didn\u2019t have anything other than what was included in our standard bylaws until about 6 months ago. When we updated the role descriptions for the team, we also developed board member role descriptions that set out the purpose of the role, core activities, outcomes and authorities. We tried to clearly distinguish between the board\u2019s governance and oversight role and the ED\u2019s operational role but there is still some blurriness. The board has also started to assess its performance via survey once a year. See board role description linked below.",
  "Role Clarity|Roles & responsibilities directory": "e.g. We have a one-page internal directory listing each team, what they are responsible for, and who to contact for common queries \u2014 for example, who leads on government relations, who manages funder relationships, who handles media requests. It is pinned in our staff Slack channel and included in the onboarding pack, however a lot of people seem to forget about it. We also have an organizational chart showing reporting lines. See internal directory linked below.",
  "Safety & Fairness|Policies to prevent harassment, discrimination & retaliation": "e.g. Our staff handbook includes a code of conduct, an anti-harassment and bullying policy, and an escalation procedure. The code sets out specific behaviours we will not tolerate, with examples relevant to our context, including how we expect staff to treat partners, stakeholders, and each other. The escalation procedure sets out the steps from informal conversation through to formal hearing and dismissal, with timelines at each stage. All staff read and sign the handbook on joining and we review it annually with our HR adviser. See handbook linked below.",
  "Safety & Fairness|2+ decision makers for high-stakes decisions": "e.g. We have a written policy that any decision to dismiss, promote, or significantly change a staff member\u2019s role must involve at least two people: the relevant line manager and the ED. If we need a tie-breaker, we bring in a third staff member from outside the relevant team who was not involved in the original decision. However, sometimes it\u2019s hard to figure out who the best person is. For hiring, we generally involve three people (including at least one peer or from a grade below) in the process and use a scoring sheet to minimize bias. Sometimes the process feels too slow and burdensome, but we haven\u2019t tried to make any changes yet. See section 7 in the handbook.",
  "Safety & Fairness|Escalation process": "e.g. We have a grievance procedure written in plain language covering both formal and informal routes in our staff handbook. It includes an explanation on how to raise issues directly with line managers and how to escalate them to the ED or the Board Chair via a form. The procedure is also explained during onboarding. We\u2019ve never had to use it so it\u2019s hard to say whether it works well in practice. See section 8 in the handbook.",
  "Safety & Fairness|Strategy to enable inclusion on the team": "e.g. We have our communication norms spelled out in our handbook. For example, for meetings, we ask everyone to send out agendas at least 48 hours in advance, we rotate facilitators, and give people the option to offer input in writing before/after the meeting. We ask all new starters in their first week whether they have any access needs or working style preferences, and we act on these. See communication norms in section 4 of the handbook.",
  "Safety & Fairness|Compensation formula (if relevant)": "e.g. We have a pay framework with three bands tied to expertise, scope and complexity. Each band corresponds to a fixed amount and we don\u2019t allow negotiations. We offer cost of living adjustments every year (if budget allows) and offer the same benefits for all full-time staff (pension contribution, health insurance and unlimited PTO). The pay and benefits framework is included in the handbook so everyone has access to it. See section 6 in the handbook.",
  "Safety & Fairness|Termination process": "e.g. Our termination process sets out each stage from informal conversation through to formal dismissal, with clear timelines and a right of appeal at every formal stage. It distinguishes between performance issues and misconduct and sets out different steps for each. We review it annually with an HR adviser to make sure it reflects current employment law in our jurisdiction. See section 10 in the handbook.",
  "Safety & Fairness|Independent board and/or a system to minimize conflict of interest": "e.g. Our board is fully independent. We have a conflicts of interest policy that all board members sign on joining and annually thereafter, and it is a standing agenda item at every board meeting. Any board member with a relevant interest in a decision declares it and leaves the room. We log all declarations in our board minutes. See conflict of interest policy linked below. The ED\u2019s salary is set by a committee of three board members, without the ED present, and follows our salary bands. The board assesses the ED\u2019s performance once a year. The process is led by the Board Chair who gathers feedback from the rest of the board as well as the staff via a survey, then holds a meeting with the ED and another board member present. The feedback is documented in a shared document. See template linked below.",
  "Feedback & Learning|Goal-tracking process": "e.g. We use the same shared document mentioned previously in the impact measurement section. Each month we update our metrics to track progress against our organizational goals. Quarterly we have a retrospective meeting where we reflect on our progress and extract any learnings. The ED shares a summary of our progress quarterly with the board.",
  "Feedback & Learning|Feedback norms & nudges": "e.g. Our communication norms document also outlines our approach to feedback: it should be timely, specific, and include an impact statement. Everyone takes a feedback skills workshop as part of the onboarding process and our 1-on-1 meeting template includes a feedback nudge. We also do yearly engagement surveys, which is an opportunity to assess our feedback culture.",
  "Feedback & Learning|Retrospectives": "e.g. Every team does a brief retrospective at the end of each quarter: what went well, what did not go well, and one thing we will do differently next quarter. We have a rotating note-taker to ensure key learnings and next steps are captured. The leadership team does a more in-depth retrospective at the end of each year as part of our strategic planning process. We also run a retrospective after any major campaign or policy moment within two weeks of its conclusion.",
  "Feedback & Learning|Performance assessments": "e.g. We do a structured annual performance review for all staff using the template linked below. It covers progress against agreed goals as well as our values and behaviours. The process is outlined in our staff handbook. See section 5.",
  "Feedback & Learning|Engagement survey & action process": "e.g. We run an engagement survey every six months. We ask 20-30 questions depending on whether there\u2019s anything specific we\u2019re trying to assess. A summary of the results is shared with all staff within two weeks of closing. The leadership team identifies 2\u20133 commitments in response to each survey and reports back on progress towards those commitments quarterly. See survey from last year linked below.",
  "Feedback & Learning|Individual development plans": "e.g. Every staff member has a development plan agreed at their annual review and revisited regularly during 1-on-1s with their line managers. Plans cover skills to develop, experience to gain, and any formal training or qualifications being pursued. We have an annual training budget per person that staff can use flexibly, plus a pool fund for larger team-wide development opportunities. Managers are expected to actively support development and it\u2019s part of their role descriptions. See template linked below.",
  "Feedback & Learning|Turnover tracking": "e.g. We conduct exit interviews with all departing staff using a consistent format covering reasons for leaving, what we could have done differently, and whether they would recommend us as a place to work. We track voluntary and involuntary turnover separately and note whether each departure was regrettable. We share a summary with the board annually and flag any patterns \u2014 for example, if multiple people leave a particular team or cite the same issue. See exit interview template linked below.",
  "Feedback & Learning|Innovation & experimentation": "e.g. Innovation is one of our core values and we do our best to encourage all staff to explore and experiment trying new things. During our quarterly retrospectives meetings, we dedicate a few minutes to hold an ideas session where staff can propose new approaches without needing a full plan. We celebrate experiments that did not work as much as ones that did. We track the number of experiments run and what we learned from them in our retrospective meetings.",
  "Feedback & Learning|Process to get team input on strategic decisions": "e.g. We have two standing channels for staff input. First, an annual staff survey that feeds directly into our planning process. Results are shared and visibly shape our priorities. Second, monthly ED office hours, a 45-minute open slot any staff member can book for any reason, including raising strategic questions. For significant one-off decisions we run a dedicated consultation process with a clear timeline and feedback loop.",
  "Leadership|Leader & manager role clarity": "e.g. We have written role descriptions for each level of leadership \u2014 team lead, senior manager, and ED \u2014 that set out the scope of the role, what decisions sit at that level, what the person is accountable for, and how success is measured. They are shared with all staff so everyone understands what to expect from leaders at each level. We review them annually and as needed. See document linked below.",
  "Leadership|Access to leaders": "e.g. The ED runs monthly open office hours \u2014 a dedicated slot any staff member can book directly, without going through their manager. We also create regular opportunities for staff and board members to connect informally, including inviting a rotating staff member to each board meeting, so that staff feel comfortable raising concerns with the board if needed. We ask about access to leadership in every engagement survey.",
  "Leadership|Leader & manager assessment": "e.g. We use a 360 feedback process for all managers annually \u2014 direct reports, peers, and the manager\u2019s own manager each provide structured input using a consistent set of questions. Results are shared with the manager during their annual review and used to shape their development plan. We also include questions about management quality in our engagement survey and track this trend over time.",
  ...
  "Leadership|Leadership team structure (if relevant)": "e.g. The leadership team structure is illustrated in our org chart. The team consists of one representative from each of our five departments. We meet on a monthly basis to review org-level challenges and priorities. These meetings run well, but it is sometimes hard to know how we should make decisions. At annual strategic planning, we take time to reflect on how we have been collaborating as a leadership team, and make adjustments to our collaboration norms as needed.",
  ...
  "Stability|Strategy for expanding team diversity": "e.g. We have a deliberate strategy for expanding the diversity of our team, developed in line with employment law in our jurisdiction. This includes advertising all roles on platforms that reach underrepresented groups, using structured interviews and scoring rubrics to reduce bias, and ensuring diverse shortlists where possible. We collect and review diversity data annually and use it to identify where we have gaps and adjust our approach. We have a staff working group focused on inclusion that meets regularly and feeds recommendations to the leadership team.",
  "Scalability|Individualized support system": "e.g. Every staff member has a named line manager responsible for their day-to-day support, performance, and development. All new starters are paired with a peer buddy from outside their team for their first three months. The ED has skip-level conversations with all non-management staff twice a year. We track whether these touchpoints are happening as part of our annual people management audit, which the board reviews.",
  "Scalability|Weekly or bi-weekly 1-on-1s": "e.g. All managers hold weekly or biweekly one-to-ones with each direct report. We have a standard template covering: how the person is doing, progress on current priorities, any blockers, feedback, and a standing development question. One-to-ones are the staff member\u2019s meeting \u2014 they set the agenda. We ask about one-to-one quality in every engagement survey. See linked 1-1 agenda template.",
  "Scalability|Hiring process": "e.g. We have a written hiring process guide covering every stage from role sign-off through to offer. It includes a role description template, standard application questions, a two-stage interview structure, a scoring rubric, a work sample task, and reference check guidance. All interview panels have at least two people, at least one of whom has completed unconscious bias training, and final hiring decisions require sign-off from three people to minimize bias.",
  "Scalability|Onboarding process": "e.g. We have a structured onboarding document for all new starters that sets out clear goals for the first 30, 60, and 90 days. During the first month, new starters have weekly check-ins with their manager to ensure they are settling in and getting what they need. These shift to bi-weekly in months two and three as they become more established. New starters also have a named buddy for their first 90 days. At the end of each milestone we do a brief formal check-in to review progress against the goals for that period. We update the onboarding document based on new starter feedback after every hire. See document linked below.",
};
// ═══════════════ BUILD CLIENT FORM ═══════════════
...
function buildSystemItem(driver, item, isFirst, placeholder) {
  ...
  const questionNumber = driver.items.indexOf(item) + 1;
