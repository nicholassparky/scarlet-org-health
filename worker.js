...
function buildSystemItem(driver,item){
  ...
  return '<div class="system-item">'+
    ...
    '<textarea class="item-textarea" id="notes-area-'+enc+'" placeholder="Describe where things currently stand for this system…" onchange="state.notes[\''+key+'\']=this.value; if(!sessionId){sessionId=generateSessionId();showSessionBar();} scheduleSave();"></textarea>'+
